...
export const ProfileView: React.FC<ProfileViewProps> = ({ onNavigate, favoritesCount, onLogout }) => {
  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark pb-24 font-display">
      ...
      <div className="px-4 py-6 flex flex-col items-center">
        ...
        <p className="text-sm text-slate-500 dark:text-gray-400 font-medium">Student Member • alex.j@example.com</p>
      </div>
